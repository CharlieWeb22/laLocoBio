 ...
 */
final class Version20200526154058 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article_onvaplusloin (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, chapeau LONGTEXT DEFAULT NULL, image_onvaplusloin VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, contenu LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, auteur VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE article_onvaplusloin');
