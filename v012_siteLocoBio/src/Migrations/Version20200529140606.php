 ...
 */
final class Version20200529140606 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article_onvaplusloin ADD is_published TINYINT(1) NOT NULL, CHANGE image_onvaplusloin image_onvaplusloin VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article_onvaplusloin DROP is_published, CHANGE image_onvaplusloin image_onvaplusloin VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
