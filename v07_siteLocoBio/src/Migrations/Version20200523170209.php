 ...
 */
final class Version20200523170209 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, origine VARCHAR(255) DEFAULT NULL, reference VARCHAR(255) DEFAULT NULL, prix NUMERIC(6, 2) DEFAULT NULL, image_produit VARCHAR(255) NOT NULL, poids NUMERIC(3, 1) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
